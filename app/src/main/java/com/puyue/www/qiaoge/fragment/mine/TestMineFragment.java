...
public class TestMineFragment extends BaseFragment {
    ...
    public static TestMineFragment getInstance() {
        TestMineFragment fragment = new TestMineFragment();
...
//                startActivity(MyCouponsActivity.getIntent(getContext(), MyCouponsActivity.class));
    ...
    private void getProductsList() {
        ProductListAPI.requestData(mActivity,pageNum,pageSize,"new",null)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
