...
public class ChooseSendAddresssAdapter extends BaseQuickAdapter<AddressModel.DataBean, BaseViewHolder> {
    String orderId;
    ChooseAddresssAdapter.Onclick onclick;
    private ChooseAddresssAdapter.OnEventClickListener mOnEventClickListener;
    public ChooseSendAddresssAdapter(int layoutResId, @Nullable List<AddressModel.DataBean> data, String orderId, ChooseAddresssAdapter.Onclick onclick) {
    ...
    public void setOnItemChangeClickListener(ChooseAddresssAdapter.OnEventClickListener onEventClickListener) {
