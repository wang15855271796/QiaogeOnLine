...
public class FundView extends BaseView {
    ...
    //x、y轴指示文字字体的大小
    protected float mXYTextSize = 28;
    //左侧文字距离左边线线的距离
    protected float mLeftTxtPadding = 10;
    //底部文字距离底部线的距离
    protected float mBottomTxtPadding = 50;


    //内部X轴虚线。允许修改。
    protected Paint mInnerXPaint;
    protected float mInnerXStrokeWidth = 2;

    //折线。允许修改。
    protected Paint mBrokenPaint;
    //单位：sp.。允许修改。
    protected float mBrokenStrokeWidth = 2;
...
//        drawLongPress(canvas);
    ...
    private void initLoadingPaint() {
        ...
        mLoadingPaint.setColor(getColor(R.color.color_fundView_brokenLineColor));
    ...
    private void initInnerXPaint() {
        ...
        mInnerXPaint.setColor(getColor(R.color.textColor_actionsheet_msg));
    ...
    private void initXYPaint() {
        mXYPaint = new Paint();
        mXYPaint.setColor(getColor(R.color.color_8B8B8B));
    ...
    private void initBrokenPaint() {
        ...
        mBrokenPaint.setColor(getColor(R.color.dash));
    ...
    private void drawLongPress(Canvas canvas) {
        ...
        timePaint.setColor(getColor(R.color.color_fundView_brokenLineColor));
...
//        hintPaint.setColor(getColor(R.color.color_fundView_brokenLineColor));
//        canvas.drawText("累计",
//                mBaseWidth - mBasePaddingRight - mLongPressPaint.measureText(finalFundMode.dataY + "")
//                        - hintPaint.measureText("累计"),
...
//                mBasePaddingLeft + r + 10 + hintPaint.measureText("累计") + 5,
