...
//    queryReturnProdIsContainFullGift
     ...
     * 获取配送地址 ，配送时间
     */
    public static final String Get_Send_Info = "common/getSendAddressTimeByDefault";

    /**
     * 获取授权
     */
    public static final String Get_Authorize = "user/userAuthorize";
    /**
     * 新必买清单
     */
...
//    public static final String Search_Address_List = "address/getHomeAddressList";
    /**
     * 选择省市区
     */
     ...
     *
     */
    public static final String Get_Area = "address/searchAddressByKeyword";
     ...
     *
     */
    public static final String Get_Cart_Num = "cart/getGoodsCartNum";
     ...
     * 分类左边数据
     */
    public static final String CLASSIFY = "common/getProdAllClassify";

    /**
     * 分类左边数据
     */
    public static final String CLASSIFYS = "common/queryProdNewClassify";

    /**
     * 分类右边
     */
    public static final String CLASSIFY_RIGHT = "common/getAppProductByClassifyId";
