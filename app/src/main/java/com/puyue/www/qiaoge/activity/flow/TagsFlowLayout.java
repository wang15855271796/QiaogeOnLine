 ...
 */
public class TagsFlowLayout extends FlowLayout implements TagsAdapter.OnDataChangedListener {
    ...
    private TagFlowLayout.OnLongClickListener mOnLongClickListener;
    ...
    public TagsFlowLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setOnLongClickListener(TagFlowLayout.OnLongClickListener onLongClickListener) {
    ...
    private void changeAdapter() {
        removeAllViews();
        TagsAdapter adapter = mTagAdapter;
