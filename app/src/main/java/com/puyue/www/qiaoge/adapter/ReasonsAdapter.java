...
public class ReasonsAdapter extends BaseQuickAdapter<CancelReasonModel.DataBean, BaseViewHolder> {

    int pos = -1;
    public ReasonsAdapter(int layoutResId, @Nullable List<CancelReasonModel.DataBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, CancelReasonModel.DataBean item) {
