...
public class SnapUpCountDownTimerView1 extends LinearLayout {
    ...
    public SnapUpCountDownTimerView1.Timeout timeout;

    public SnapUpCountDownTimerView1.Timeout getTimeout() {
        return timeout;
    }

    public void setTimeout(SnapUpCountDownTimerView1.Timeout timeout) {
    ...
    public SnapUpCountDownTimerView1(Context context, AttributeSet attrs) {
        super(context, attrs);

        this.context = context;
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.view_countdowntimersss, this);
