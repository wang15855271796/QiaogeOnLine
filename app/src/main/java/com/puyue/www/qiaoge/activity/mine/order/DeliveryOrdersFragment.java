...
//            mAdapterMyOrders = new MySubOrdersItemAdapter(R.layout.item_my_order, mListResult, 2, orderDeliveryType, new MySubOrdersItemAdapter.OnClick() {
//                @Override
        ...
        MyOrderListAPI.getList(getContext(), orderStatus, pageNum, 20,orderDeliveryType,subId)
                ...
                .subscribe(new Subscriber<OrdersModel>() {
                    ...
                    public void onNext(OrdersModel myOrdersModel) {
                        ...
                        logoutAndToHome(getContext(), myOrdersModel.code);
                        mModelMyOrders = myOrdersModel;
                        if (myOrdersModel.success) {


                            updateOrderList();
                        } else {
                            AppHelper.showMsg(getActivity(), myOrdersModel.message);
                        }
                    }
                });
    }
