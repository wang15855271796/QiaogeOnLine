...
public class HotAdapterWy extends BaseQuickAdapter<ProductNormalModel.DataBean.ListBean, BaseViewHolder> {
    ...
    public HotAdapterWy(int layoutResId, @Nullable List<ProductNormalModel.DataBean.ListBean> data, Onclick onclick) {
    ...
    protected void convert(BaseViewHolder helper, ProductNormalModel.DataBean.ListBean item) {
        ...
        if(activesBean.size()>=3) {
            if(helper.getAdapterPosition()==0) {
                ...
                iv_order.setImageResource(R.mipmap.icon_one_wy);
            }else if(helper.getAdapterPosition()==1) {
                iv_order.setVisibility(View.VISIBLE);
                iv_order.setImageResource(R.mipmap.icon_two_wy);
            }else if(helper.getAdapterPosition()==2){
                iv_order.setVisibility(View.VISIBLE);
                iv_order.setImageResource(R.mipmap.icon_three_wy);
            }else {
