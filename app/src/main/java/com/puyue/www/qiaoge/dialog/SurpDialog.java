...
import com.puyue.www.qiaoge.adapter.SurpSpecsAdapter;
 ...
 */
public class SurpDialog extends Dialog implements View.OnClickListener{
    Context context;
    public View view;
    ...
    private void init() {
        ...
        searchSpecAdapter = new SurpSpecsAdapter(context,listBean.getProdSpecs());
