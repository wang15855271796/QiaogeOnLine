...
public class SnapUpCountDownTimerView3 extends LinearLayout{
    ...
    public SnapUpCountDownTimerView3(Context context, AttributeSet attrs) {
        super(context, attrs);

        this.context = context;
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.view_snap3, this);
