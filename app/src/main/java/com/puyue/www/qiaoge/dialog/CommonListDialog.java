...
public class CommonListDialog extends Dialog implements View.OnClickListener{
    ...
    public CommonListDialog(Context mContext, ExchangeProductModel.DataBean data) {
    ...
    public void init() {
        ...
        CommonItemAdapter commonItemAdapter = new CommonItemAdapter(1, item.getProdSpecs().get(0).getProductId(), R.layout.item_choose_content,
                item.getProdPrices(),item);
                    ...
                    public void onNext(ExchangeProductModel exchangeProductModel) {
                        if(exchangeProductModel.isSuccess()) {
                            if(exchangeProductModel.getData()!=null) {
                                ...
                                CommonItemAdapter commonItemAdapter = new CommonItemAdapter(1, productId, R.layout.item_choose_content,
