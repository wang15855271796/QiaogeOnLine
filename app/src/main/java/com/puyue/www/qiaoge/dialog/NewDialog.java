...
//                                Glide.with(context).load(exchangeProductModel.getData().getTypeUrl()).into(iv_pic);
                                ...
                                NewItemAdapter newItemAdapter = new NewItemAdapter(1, productId, R.layout.item_choose_content, exchangeProductModel.getData().getProdPrices(),exchangeProductModel.getData().getTypeUrl());
