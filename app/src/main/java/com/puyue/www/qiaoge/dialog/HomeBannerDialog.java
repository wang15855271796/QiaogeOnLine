...
import com.puyue.www.qiaoge.adapter.HomeBanerChooseSpecAdapter;
...
public class HomeBannerDialog extends Dialog implements View.OnClickListener{
    ...
    private HomeBanerChooseSpecAdapter chooseSpecAdapter;
    HomeBannerModel.DataBean item;
    int pos = 0;
    private ExchangeProductModel exchangeProductModel1s;
    @BindView(R.id.iv_send)
    ImageView iv_send;
    public HomeBannerDialog(Context context,int productId,HomeBannerModel.DataBean item) {
    ...
    public void init() {
        ...
        chooseSpecAdapter = new HomeBanerChooseSpecAdapter(context,item.getProdSpecs());
