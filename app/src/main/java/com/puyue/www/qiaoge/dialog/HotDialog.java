...
//                                Glide.with(context).load(exchangeProductModel.getData().getTypeUrl()).into(iv_pic);
                                ...
                                HotItemAdapter hotItemAdapter = new HotItemAdapter(1, productId, R.layout.item_choose_content, exchangeProductModel.getData().getProdPrices(),exchangeProductModel.getData().getTypeUrl());
